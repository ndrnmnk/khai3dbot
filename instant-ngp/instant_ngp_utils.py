...
def get_transforms_from_sfm_text_output(TEXT_FOLDER, IMAGE_FOLDER, OUT_PATH, AABB_SCALE=4, KEEP_COLMAP_COORDS=False):
	...
	with open(os.path.join(TEXT_FOLDER, "images.txt"), "r") as f:
		...
		for line in f:
			...
			if i % 2 == 1:
				...
				frame = {"file_path": os.path.join("./images/", os.path.basename(name)),
						 "sharpness": b,
